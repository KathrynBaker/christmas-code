...
#### These are the values you might want to change!!!

# The password in use
password = "TEST"
# The maximum number of tries to use
max_tries = 3
# The time to wait between tries
timeout = 4
# The file name of the image - keep it in the same directory!
pilImage = PIL.Image.open("IMG_0520.png")
# Font details for the display
font_name = "Courier"
font_size = 44

#### If you don't know what you are doing, don't look below here
